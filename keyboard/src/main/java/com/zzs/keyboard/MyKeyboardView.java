...
public class MyKeyboardView extends View implements View.OnClickListener {
    ...
    /**
     * Whether to take over drawing key
     */
    public interface OnKeyDrawListener {
        boolean onDrawKey(Context context,Keyboard.Key key, Canvas canvas,Paint paint,Drawable keyBackground,Rect padding,
                          int parentPaddingLeft,int parentPaddingTop,int keyTextSize,int labelTextSize);
    }
    ...
    private OnKeyDrawListener mKeyDrawListener;
    ...
    public MyKeyboardView(Context context, AttributeSet attrs) {
        this(context, attrs, R.style.KeyboardView);
    }
    ...
    public MyKeyboardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        TypedArray a = context.obtainStyledAttributes(
                attrs, R.styleable.MyKeyboardView, defStyleAttr, defStyleRes);
        ...
        for (int i = 0; i < n; i++) {
            ...
            if (attr == R.styleable.MyKeyboardView_keyBackground) {
                mKeyBackground = a.getDrawable(attr);
            } else if (attr == R.styleable.MyKeyboardView_verticalCorrection) {
                mVerticalCorrection = a.getDimensionPixelOffset(attr, 0);
            } else if (attr == R.styleable.MyKeyboardView_keyPreviewLayout) {
                previewLayout = a.getResourceId(attr, 0);
            } else if (attr == R.styleable.MyKeyboardView_keyPreviewOffset) {
                mPreviewOffset = a.getDimensionPixelOffset(attr, 0);
            } else if (attr == R.styleable.MyKeyboardView_keyPreviewHeight) {
                mPreviewHeight = a.getDimensionPixelSize(attr, 80);
            } else if (attr == R.styleable.MyKeyboardView_keyTextSize) {
                mKeyTextSize = a.getDimensionPixelSize(attr, 18);
            } else if (attr == R.styleable.MyKeyboardView_keyTextColor) {
                mKeyTextColor = a.getColor(attr, 0xFF000000);
            } else if (attr == R.styleable.MyKeyboardView_labelTextSize) {
                mLabelTextSize = a.getDimensionPixelSize(attr, 14);
            } else if (attr == R.styleable.MyKeyboardView_popupLayout) {
                mPopupLayout = a.getResourceId(attr, 0);
            } else if (attr == R.styleable.MyKeyboardView_shadowColor) {
                mShadowColor = a.getColor(attr, 0);
            } else if (attr == R.styleable.MyKeyboardView_shadowRadius) {
                mShadowRadius = a.getFloat(attr, 0f);
            } else if (attr == R.styleable.MyKeyboardView_background) {
                Drawable background = a.getDrawable(attr);
                setBackgroundDrawable(background);
            }
        }
        mBackgroundDimAmount = a.getFloat(R.styleable.MyKeyboardView_backgroundDimAmount, 0.5f);
        a.recycle();
    ...
    public void setOnKeyDrawListener(OnKeyDrawListener listener){
        mKeyDrawListener = listener;
    }
     ...
     * @see MyKeyboardView#setShifted(boolean)
     */
    ...
    private void onBufferDraw() {
        ...
        for (int i = 0; i < keyCount; i++) {
            ...
            if (mKeyDrawListener!=null&&
            mKeyDrawListener.onDrawKey(getContext(),key,canvas,paint,
                    keyBackground,padding,kbdPaddingLeft,kbdPaddingTop,mKeyTextSize,mLabelTextSize)){
                continue;
            }
